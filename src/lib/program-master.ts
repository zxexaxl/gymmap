...
export const catalogProgramMaster: ProgramMasterEntry[] = [
  ...
  defineCatalogProgramEntry({
    canonicalProgramName: "BODYPUMP HEAVY",
    comparisonKeys: ["bodypumpheavy", "body pump heavy", "ボディパンプヘビー"],
    searchHints: ["BODYPUMP HEAVY", "BODY PUMP HEAVY", "ボディパンプヘビー"],
    searchAliases: ["BODYPUMP HEAVY", "BODY PUMP HEAVY", "ボディパンプヘビー"],
    requiredMatchKeys: ["bodypumpheavy", "ボディパンプヘビー"],
    programBrand: "Les Mills",
    categoryPrimary: "strength",
    tags: ["strength", "barbell", "les_mills"],
  }),
  ...
  defineCatalogProgramEntry({
    canonicalProgramName: "LES MILLS SHAPES",
    comparisonKeys: ["lesmillsshapes", "les mills shapes"],
    searchHints: ["LES MILLS SHAPES", "LESMILLS SHAPES", "LesMills Shapes"],
    searchAliases: ["LES MILLS SHAPES", "LESMILLS SHAPES"],
    requiredMatchKeys: ["lesmillsshapes"],
    programBrand: "Les Mills",
    categoryPrimary: "mind_body",
    tags: ["mind_body", "strength", "les_mills"],
  }),
  defineCatalogProgramEntry({
    canonicalProgramName: "LES MILLS TONE",
    comparisonKeys: ["lesmillstone", "les mills tone"],
    searchHints: ["LES MILLS TONE", "LESMILLS TONE", "LesMills Tone"],
    searchAliases: ["LES MILLS TONE", "LESMILLS TONE"],
    requiredMatchKeys: ["lesmillstone"],
    programBrand: "Les Mills",
    categoryPrimary: "conditioning",
    tags: ["conditioning", "cardio", "strength", "les_mills"],
  }),
  defineCatalogProgramEntry({
    canonicalProgramName: "LES MILLS DANCE",
    comparisonKeys: ["lesmillsdance", "les mills dance"],
    searchHints: ["LES MILLS DANCE", "LESMILLS DANCE", "LesMillsDANCE"],
    searchAliases: ["LES MILLS DANCE", "LESMILLS DANCE"],
    requiredMatchKeys: ["lesmillsdance"],
    programBrand: "Les Mills",
    categoryPrimary: "dance",
    tags: ["dance", "cardio", "les_mills"],
  }),
  ...
  defineCatalogProgramEntry({
    canonicalProgramName: "RADICAL POWER",
    comparisonKeys: ["radicalpower", "radical power"],
    searchHints: ["RADICAL POWER"],
    searchAliases: ["RADICAL POWER"],
    requiredMatchKeys: ["radicalpower"],
    programBrand: "Radical Fitness",
    categoryPrimary: "strength",
    tags: ["strength", "barbell", "radical_fitness"],
  }),
  defineCatalogProgramEntry({
