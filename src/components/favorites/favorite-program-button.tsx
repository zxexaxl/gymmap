...
export function FavoriteProgramButton({ id, slug, name, compact = false }: FavoriteProgramButtonProps) {
  ...
  return (
    <button
      className={`favorite-program-button ${compact ? "is-compact" : ""} ${isFavorite ? "is-active" : ""}`}
      type="button"
