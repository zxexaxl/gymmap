-- 1. ブランドを追加したい場合は gym_brands に 1 行追加してください。
...
-- 2. 店舗を追加したい場合は gym_locations に 1 行追加してください。
-- brand_id は上の gym_brands.id に合わせます。
...
values
  ('aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111', 'Gold''s Gym 渋谷東京店', 'golds-gym-shibuya', '150-0042', '東京都', '渋谷区', '宇田川町 31-2 渋谷BEAM 6F', 35.661800, 139.698100, '渋谷駅', 'https://www.goldsgym.jp/shop/13110', 'https://www.goldsgym.jp/shop/13110/program', true, now()),
  ('aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111', 'Gold''s Gym 銀座中央店', 'golds-gym-ginza', '104-0061', '東京都', '中央区', '銀座 1-2-4 サクセス銀座ファーストビル', 35.674500, 139.769000, '銀座一丁目駅', 'https://www.goldsgym.jp/shop/13120', 'https://www.goldsgym.jp/shop/13120/program', true, now()),
  ('aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111', 'Gold''s Gym 表参道店', 'golds-gym-omotesando', '150-0001', '東京都', '渋谷区', '神宮前 4-3-2 表参道スクエア 3F', 35.667700, 139.712300, '表参道駅', 'https://www.goldsgym.jp/shop/13130', 'https://www.goldsgym.jp/shop/13130/program', true, now()),
  ...
  ('ccccccc3-cccc-cccc-cccc-ccccccccccc3', '33333333-3333-3333-3333-333333333333', 'セントラルスポーツ 吉祥寺', 'central-kichijoji', '180-0004', '東京都', '武蔵野市', '吉祥寺本町 1-10-1', 35.703400, 139.579600, '吉祥寺駅', 'https://www.central.co.jp/club/kichijoji/', 'https://www.central.co.jp/club/kichijoji/schedule/', true, now())
on conflict (id) do nothing;

-- 3. プログラムを追加したい場合は programs と program_aliases に追加してください。
...
values
  ...
  ('44444444-4444-4444-4444-444444444443', 'ヨガ', 'yoga', 'Mind & Body', '呼吸と姿勢を整える定番クラス', 2, true, 60),
  ('44444444-4444-4444-4444-444444444444', 'ピラティス', 'pilates', 'Mind & Body', '体幹を意識したコンディショニング', 2, true, 50)
on conflict (id) do nothing;
...
-- 4. クラスを追加したい場合は class_schedules に 1 行追加してください。
-- location_id は gym_locations.id、program_id は programs.id に合わせます。
...
values
  ...
  ('66666666-6666-6666-6666-666666666662', 'aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '44444444-4444-4444-4444-444444444442', 'BODYPUMP 45', 'wednesday', '18:30', '19:15', 45, 'メインスタジオ', 'Tanaka', 'https://example.com/golds-ginza/bodypump', '2026-04-01', now()),
  ('66666666-6666-6666-6666-666666666663', 'bbbbbbb1-bbbb-bbbb-bbbb-bbbbbbbbbbb1', '44444444-4444-4444-4444-444444444443', '朝のヨガ', 'tuesday', '10:00', '11:00', 60, 'スタジオ 2', 'Aki', 'https://example.com/konami-shinjuku/yoga', '2026-04-01', now()),
  ('66666666-6666-6666-6666-666666666664', 'bbbbbbb2-bbbb-bbbb-bbbb-bbbbbbbbbbb2', '44444444-4444-4444-4444-444444444444', 'ベーシックピラティス', 'friday', '20:00', '20:50', 50, 'ボディスタジオ', 'Mori', 'https://example.com/konami-ikebukuro/pilates', '2026-04-01', now()),
  ('66666666-6666-6666-6666-666666666665', 'ccccccc1-cccc-cccc-cccc-ccccccccccc1', '44444444-4444-4444-4444-444444444443', 'リラックスヨガ', 'saturday', '09:30', '10:30', 60, 'スタジオ Green', 'Kato', 'https://example.com/central-omori/yoga', '2026-04-01', now()),
  ('66666666-6666-6666-6666-666666666666', 'ccccccc2-cccc-cccc-cccc-ccccccccccc2', '44444444-4444-4444-4444-444444444441', 'BODYCOMBAT 30', 'sunday', '13:00', '13:30', 30, 'スタジオ Red', 'Nakamura', 'https://example.com/central-kinshicho/bodycombat', '2026-04-01', now()),
  ('66666666-6666-6666-6666-666666666667', 'aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '44444444-4444-4444-4444-444444444443', 'ヨガストレッチ', 'thursday', '12:30', '13:30', 60, 'マインド&ボディスタジオ', 'Mika', 'https://example.com/golds-omotesando/yoga', '2026-04-01', now()),
  ('66666666-6666-6666-6666-666666666668', 'aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '44444444-4444-4444-4444-444444444442', 'BODYPUMP 30', 'saturday', '14:00', '14:30', 30, 'メインスタジオ', 'Kenta', 'https://example.com/golds-omotesando/bodypump', '2026-04-01', now()),
  ('66666666-6666-6666-6666-666666666669', 'ccccccc3-cccc-cccc-cccc-ccccccccccc3', '44444444-4444-4444-4444-444444444444', 'ピラティス ベーシック', 'monday', '11:30', '12:20', 50, 'コンディショニングスタジオ', 'Yui', 'https://example.com/central-kichijoji/pilates', '2026-04-01', now())
on conflict (id) do nothing;
...
values
  ...
  ('77777777-7777-7777-7777-777777777777', 'aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaa3', 'location_schedule', 'https://www.goldsgym.jp/shop/13130/program', 'html', 'manual_seed_v1', now(), now(), 'success', 'success', 'MVP seed data'),
  ...
  ('77777777-7777-7777-7777-777777777778', 'ccccccc3-cccc-cccc-cccc-ccccccccccc3', 'location_schedule', 'https://www.central.co.jp/club/kichijoji/schedule/', 'html', 'manual_seed_v1', now(), now(), 'success', 'success', 'MVP seed data')
on conflict (id) do nothing;
...
values
  ('88888888-8888-8888-8888-888888888881', now(), now(), 'manual', 'success', 8, 8, 0, 0, '{"message":"Seed data inserted"}'::jsonb)
on conflict (id) do nothing;
...
values
  ...
  ('99999999-9999-9999-9999-999999999997', '88888888-8888-8888-8888-888888888881', '77777777-7777-7777-7777-777777777777', 'success', 2, 2, 0, null, '{"parser":"manual_seed_v1"}'::jsonb),
  ...
  ('99999999-9999-9999-9999-999999999998', '88888888-8888-8888-8888-888888888881', '77777777-7777-7777-7777-777777777778', 'success', 1, 1, 0, null, '{"parser":"manual_seed_v1"}'::jsonb)
on conflict (id) do nothing;
